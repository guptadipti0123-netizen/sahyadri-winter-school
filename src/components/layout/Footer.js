...
export default function Footer() {
  ...
  return (
    <footer className="relative text-white pt-12 sm:pt-16 pb-8 sm:pb-10 overflow-hidden font-sans">
      ...
      {/* --- BACKGROUND IMAGE SETUP (Sahyadri Landscape Photo - Crisp & Clear) --- */}
      <div
      ...
      {/* Clear Contrast Overlay: No Blur, Clean Mountain Landscape Visible with Crisp Text */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-t from-[#180d04]/90 via-[#1f1106]/75 to-[#180d04]/80" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">

        {/* Main Responsive Grid: 2 columns on mobile, 12-col layout on desktop */}
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-x-6 sm:gap-x-8 gap-y-8 sm:gap-y-10 mb-10 sm:mb-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-4 space-y-3 pb-1 sm:pb-0">
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl text-[#fdfbf7] tracking-tight font-bold drop-shadow-md">
              Sahyadri Rural Connect
            </h2>
            <p className="text-[#ebe2d1]/90 text-xs sm:text-sm leading-relaxed max-w-sm font-normal">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            <h4 className="text-[#d4a825] font-bold mb-3.5 uppercase tracking-wider text-[11px] sm:text-xs border-b border-[#d4a825]/40 pb-1.5 inline-block">
              Quick Links
            </h4>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 border-t border-white/15 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-[#ebe2d1]/80 font-medium">
