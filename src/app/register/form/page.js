...
export default function RegisterFormPage() {
  ...
  return (
    <main className="min-h-screen relative overflow-x-hidden font-sans bg-[#f5efe2] text-[#3e2410]">
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="relative isolate pt-16 sm:pt-28 md:pt-36 pb-8 sm:pb-12 md:pb-14 overflow-hidden bg-gradient-to-b from-[#faede0] via-[#f7e6d5] to-[#f5efe2] text-[#3e2410] border-b border-[#dccdb2]/80">
