...
export default function RegisterPage() {
  ...
  const highlights = [
    {
      ...
      title: 'Curated 40-Scholar Cohort',
  ...
  const faqs = [
    {
      ...
      a: 'By submitting the registration form, you register your application for the upcoming immersion camp. When admissions officially open, selection guidelines, schedule details, and confirmation will be sent directly to your registered email.'
    },
    {
      q: 'Is prior rural or trekking experience mandatory?',
      a: 'Not at all. The camp welcomes students and researchers from all backgrounds. All you need is intellectual curiosity, empathy, and willingness to participate actively in community life.'
    },
    {
      q: 'Are food, lodging, and local transit arranged?',
      a: 'Yes. All selected scholars receive organized community lodging, authentic nutritious Maharashtrian meals, and guided field logistics throughout the 5 days.'
    },
    {
      q: 'Will participants receive a certificate?',
      a: 'Yes. All participants who complete the 5-day immersion and present their group action blueprint will receive an official Certificate of Rural Immersion from Sahyadri Rural Connect.'
    }
  ];
  ...
  return (
    <main className="min-h-screen relative overflow-x-hidden font-sans bg-[#f5efe2] text-[#3e2410]">
      ...
      <section className="relative isolate z-10 pt-16 sm:pt-24 lg:pt-32 pb-8 sm:pb-12 bg-gradient-to-b from-[#faede0] via-[#f7e6d5] to-[#f5efe2] border-b border-[#dccdb2]/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

          {/* DESKTOP SPLIT GRID (lg: 2-Cols) | MOBILE FLOW: Template on Top (order-1), Content on Bottom (order-2) */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center">

            {/* ================= 1. POSTER SHOWCASE CARD (Top on Mobile, Right on Desktop) ================= */}
            <div className="order-1 lg:order-2 lg:col-span-5 flex flex-col items-center justify-center w-full">

              <div className="relative w-full max-w-[380px] sm:max-w-[420px] rounded-[28px] overflow-hidden shadow-xl border border-[#dccdb2] bg-[#fdfbf7] text-[#3e2410] font-sans group transition-all duration-500 hover:shadow-2xl">

                {/* Real Photo Banner */}
                <div className="relative h-48 sm:h-52 w-full bg-[#3e2410] overflow-hidden">
                  <Image
                ...
                <div className="p-4 sm:p-5 pt-3 space-y-3">
                  ...
                  <div className="text-center space-y-0.5 border-b border-[#dccdb2] pb-2.5">
                    <h4 className="font-serif text-base sm:text-lg font-bold text-[#7a3a1c] leading-snug">
                      Winter 2026 • Registration Loading
                    </h4>
                    <p className="text-xs font-semibold text-[#7a5232]">
                      Palghar &amp; Sahyadri Rural Hamlets (Maharashtra)
                    </p>
                  </div>

                  {/* 6 Immersion Pillars (3x2 Grid) */}
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="bg-[#f5efe2] p-2 rounded-xl border border-[#dccdb2] flex flex-col items-center justify-center min-h-[64px]">
                  ...
                  <Link
                    href="/register/form"
                    className="w-full py-3 rounded-full bg-[#1f5c54] hover:bg-[#124d45] text-white font-bold text-xs flex items-center justify-center gap-2 shadow-sm active:scale-95 transition-all text-center"
                  >
            ...
            <div className="order-2 lg:order-1 lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-4 sm:space-y-6">
              ...
              {/* Narrative Subtitle */}
              <p className="text-sm sm:text-base md:text-lg text-[#7a5232] max-w-2xl leading-relaxed font-normal">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 pt-1">
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#fdfbf7] border border-[#dccdb2] text-[#3e2410] text-xs font-semibold shadow-2xs">
                ...
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#fdfbf7] border border-[#dccdb2] text-[#3e2410] text-xs font-semibold shadow-2xs">
                  ...
                  <span>Interdisciplinary Cohort</span>
                </div>
              </div>
