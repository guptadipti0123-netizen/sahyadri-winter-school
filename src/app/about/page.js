        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-[#faf7f2] border-2 border-[#ebdcc6] shadow-xs relative">
              ...
              <p className="font-serif italic text-xs sm:text-sm md:text-[14.5px] text-evergreen leading-relaxed pr-6 text-left">
      ...
      <section id="contact-section" className="py-14 sm:py-20 px-4 sm:px-6 md:px-8 bg-white border-t border-[#ebdcc6] relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            <div className="lg:col-span-7 bg-[#faf7f2] border-2 border-[#ebdcc6] p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-sm text-left">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-gradient-to-r from-sea_green to-dark_emerald text-white text-xs md:text-sm font-bold shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all cursor-pointer"
                  >
